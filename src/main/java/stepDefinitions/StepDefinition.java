...
// -----------------------QUERY(07) (Prepared Statement)--------
    ...
    @Given("Prepared query04 olusturulur ve execute edilir.")
    public void prepared_query04_olusturulur_ve_execute_edilir() throws SQLException {
    ...
    @Given("Prepared query04 Sonuclar dogrulanir.")
    public void prepared_query04_sonuclar_dogrulanir() {
...
// ---------------------------QUERY 09 ------------------------------------
    ...
    preparedStatement=JDBCReusableMethods.getConnection().prepareStatement(query);
    id=faker.number().numberBetween(450,500);
